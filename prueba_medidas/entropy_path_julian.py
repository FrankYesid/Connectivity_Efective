# -*- coding: utf-8 -*-
"""
Created on Wed Sep 23 17:26:56 2020

@author: frany
"""
# -*- coding: utf-8 -*-
"""
Created on Wed Sep 23 17:18:04 2020
...
if __name__ == '__main__':
    ...
    #int(args.f1)
    Strength = loadmat('path_len_2.mat')['path_']
    freqs = [3,5,7,9]
    tau = 3  
    Entro = []
    for fr in range(0,4):
        ...
        for sub in range(0,50):
            Data = np.array(X_[sub,:]).reshape((1,-1))
            r = 0.2*np.std(Data)
...
print('Save Entropy')
savemat('Entropy_path_2.mat', {'Entrpy':Entr})